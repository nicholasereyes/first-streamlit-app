...
st.write("""Alright, plot twist—poor states actually have lower Week 1 elimination rates **(20% vs. a 32% elimination rate for those who come from states where the average household income is at least $80K)**. Who would've thought? Turns out, the producers might not care if you're a CEO or an aspiring Instagram model, as long as you’re coming from a state where the median income is closer to the "Let’s get by" end of the spectrum, you’ve got a better shot at staying. Maybe it’s the underdog spirit? Or maybe they just like the drama of someone fighting their way through life and love. Either way, it’s a fascinating, totally unexpected trend. Now, this doesn't mean you can show up in a pair of flip-flops and a smile and still get a rose—but hey, at least you’ve got a fighting chance.
""")
